...
class StreamSetAnalogOutputScheduleRequest: public Serializable {
public:
    int interfaceId {0};
    int device {0};
    int streamId {0};
    ...
    StreamSetAnalogOutputScheduleRequest();
    ...
    bool operator==(const StreamSetAnalogOutputScheduleRequest& other) const;
