...
class DeviceSetDigitalOutputScheduleRequest: public Serializable {
public:
    int interfaceId {0};
    int device {0};
    int channelNumber {0};
    ...
    DeviceSetDigitalOutputScheduleRequest();
    ...
    bool operator==(const DeviceSetDigitalOutputScheduleRequest& other) const;
